...
const TabNavList = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  return /*#__PURE__*/React.createElement(_resizeObserver.default, {
    ...
    className: (0, _classnames.default)(`${prefixCls}-nav`, className, tabsClassNames?.header),
    style: {
      ...styles?.header,
      ...style
    },
    ...
    className: (0, _classnames.default)(wrapPrefix, {
    ...
    className: (0, _classnames.default)(`${prefixCls}-ink-bar`, tabsClassNames?.indicator, {
