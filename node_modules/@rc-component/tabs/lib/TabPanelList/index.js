...
const TabPanelList = props => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: (0, _classnames.default)(`${prefixCls}-content-holder`)
  }, /*#__PURE__*/React.createElement("div", {
    className: (0, _classnames.default)(`${prefixCls}-content`, `${prefixCls}-content-${tabPosition}`, {
    ...
    return /*#__PURE__*/React.createElement(_motion.default, _extends({
      ...
      className: (0, _classnames.default)(contentClassName, paneClassName, motionClassName),
      ref: ref
    })));
  })));
};
